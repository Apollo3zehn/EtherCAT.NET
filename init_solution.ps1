...
if ($IsWindows)
{
	cmake ./../../native -DCMAKE_CONFIGURATION_TYPES:STRING="Debug;Release" -G "Visual Studio 16 2019" 
}
elseif ($IsLinux)
{
...
if ($IsWindows)
{
	cmake ./../../native -DCMAKE_CONFIGURATION_TYPES:STRING="Debug;Release" -G "Visual Studio 16 2019 Win64"
}
elseif ($IsLinux)
{
